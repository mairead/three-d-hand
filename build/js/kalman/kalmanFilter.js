...
var x_0 = $V([1.75,-0.03,-1.0]); //vector. Initial accelerometer values.
...
var z_k = $V([1.75,-0.03,-1.0]); //Updated accelerometer values. Is this amount to correct in each pass? 
//var z_k = $V([0,0,0]);
var H_k = $M([
              [1,0,0],
              [0,1,0],
